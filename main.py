...
async def main(page: ft.Page):
    ...
    cln0 = ft.Column(controls=[H_inst[0]] + btns_matrix[f'1'], spacing=7)
    cln1 = ft.Column(controls=[H_inst[1]] + btns_matrix[f'2'], spacing=7)
    cln2 = ft.Column(controls=[H_inst[2]] + btns_matrix[f'3'], spacing=7)
    cln3 = ft.Column(controls=[H_inst[3]] + btns_matrix[f'4'], spacing=7)
    cln4 = ft.Column(controls=[H_inst[4]] + btns_matrix[f'5'], spacing=7)
    cln5 = ft.Column(controls=[H_inst[5]] + btns_matrix[f'6'], spacing=7)
    cln6 = ft.Column(controls=[H_inst[6]] + btns_matrix[f'7'], spacing=7)
    cln7 = ft.Column(controls=[H_inst[7]] + btns_matrix[f'8'], spacing=7)
